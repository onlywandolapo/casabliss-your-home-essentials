...
export const products: Product[] = [
  ...
  { id: 'pr-105', name: 'Turkey', description: 'Smoked or grilled turkey piece', price: 3000, image: proteinsCatImg, category: 'proteins', inStock: true },
  { id: 'pr-106', name: 'Turkey (Small)', description: 'Smaller piece of grilled turkey', price: 2000, image: proteinsCatImg, category: 'proteins', inStock: true },
  ...
  { id: 'pr-118', name: 'Fried Plantain (Dodo)', description: 'Sweet fried plantain slices', price: 500, image: nigerianDishesCatImg, category: 'proteins', inStock: true },
  ...
  { id: 'sn-101', name: 'Donut', description: 'Soft glazed donut', price: 500, image: snacksCategoryImg, category: 'snacks', inStock: true },
  { id: 'sn-102', name: 'Jam Donut', description: 'Donut filled with sweet jam', price: 600, image: snacksCategoryImg, category: 'snacks', inStock: true },
  ...
  { id: 'sn-104', name: 'Chin Chin (Small)', description: 'Crunchy Nigerian chin chin snack', price: 200, image: snacksCategoryImg, category: 'snacks', inStock: true },
  { id: 'sn-105', name: 'Chin Chin (Large)', description: 'Large pack of crunchy chin chin', price: 600, image: snacksCategoryImg, category: 'snacks', inStock: true },
  { id: 'sn-106', name: 'Puff Puff', description: 'Soft fluffy Nigerian puff puff', price: 200, image: snacksCategoryImg, category: 'snacks', inStock: true },
  ...
  { id: 'sn-108', name: 'Small Chops', description: 'Assorted Nigerian party finger foods', price: 1500, image: snacksCategoryImg, category: 'snacks', inStock: true },
  ...
  { id: 'sn-110', name: 'Tightnut Pastry', description: 'Premium nut pastry treat', price: 2700, image: snacksCategoryImg, category: 'snacks', inStock: true },
  ...
  { id: 'sn-115', name: 'Small Plantain Chips', description: 'Crunchy plantain chips (small pack)', price: 500, image: snacksCategoryImg, category: 'snacks', inStock: true },
  { id: 'sn-116', name: 'Big Plantain Chips', description: 'Crunchy plantain chips (large pack)', price: 2000, image: snacksCategoryImg, category: 'snacks', inStock: true },
  { id: 'sn-117', name: 'Small Potato Chips', description: 'Crispy potato chips (small)', price: 500, image: snacksCategoryImg, category: 'snacks', inStock: true },
  { id: 'sn-118', name: 'Big Potato Chips', description: 'Crispy potato chips (large)', price: 1500, image: snacksCategoryImg, category: 'snacks', inStock: true },
